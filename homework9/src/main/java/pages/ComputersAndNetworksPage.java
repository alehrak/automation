...
public class ComputersAndNetworksPage extends BasePage {
    ...
    private static final String PATH_CHECK_EXISTENCE_VERTICAL_LIST =
            "(//div[@class='catalog-navigation-list__wrapper']//div[@class='catalog-navigation-list__aside-list'])[3]";
    ...
    public void openCatalog() {
        ...
        $x(OPEN_CATALOG_ONLINER).click();
    }

    @Override
    public void openPage() {
        openCatalog();
        $x(OPEN_PAGE_COMPUTER_AND_NETWORKS).click();
    }

    public boolean checkListItemForExistence() {
        return $x(PATH_CHECK_EXISTENCE_VERTICAL_LIST).hover().exists();
    }

    public List<String> getSectionComputersAndNetworks() {
        ElementsCollection elements = $$x(PATH_GETTING_SECTIONS_VERTICAL_LIST);
